...
function ChatBox() {
  ...
  return (
    <div className="w-1/3 border-2 border-blue-400 rounded-lg flex flex-col">
      ...
      <div className="flex-1 p-4 border-b border-blue-400" style={{ maxHeight: '400px', overflowY: 'auto' }}>
      ...
      <div className="flex p-1">
        <input
          type="text"
          className="self-end w-full bg-white text-black outline-none p-2 text-sm"
